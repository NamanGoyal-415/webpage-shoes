...
function Footer() {
  return (
    <>
      <footer className="bg-black mt-14 pt-7 ">
        <div className=" container mx-auto px-3 pb-10">
          <div className=" flex flex-row flex-wrap mx-3">
            <div className=" lg:w-1/3 w-full">
              <img className=" w-[90px] " src={footlogo} alt="logo" />
              <p className="mb-5 footer-text family-pops md:text-base text-xs not-italic font-normal text-white ">
              ...
              <div className="flex gap-3">
                ...
                <a href="https://twitter.com/" target="_blank" class="f-svg">
                  <svg
                    class="mx-1"
                    xmlns="http://www.w3.org/2000/svg"
                    width="36"
                ...
                <a href="https://www.google.com/" target="_blank" class="f-svg">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="36"
                    height="35"
            ...
            <div className="w-full lg:w-2/3 pt-11">
              <div className="flex flex-row flex-wrap mx-3 pt-5">
                <div className=" sm:w-1/4 w-3/6 flex items-center flex-col pt-0 sm:pt-5">
                  <h5 className="family-pops md:text-lg text-sm font-semibold not-italic text-white mb-4 ">
                    CUSTOM LINKS
                  </h5>
                  <ul className="px-0">
                    <li className="mb-3">
                      <a
                        href=""
                        className="text-[#b6b6b6] family-pops md:text-lg text-xs font-normal not-italic links"
                      >
                        Lorem ipsum
                      </a>
                    </li>
                ...
                <div className=" sm:w-1/4 w-3/6 flex items-center flex-col pt-0 sm:pt-5 mt-4 sm:mt-0">
                  <h5 className="family-pops md:text-lg text-sm font-semibold not-italic text-white mb-4 ">
                    OUR COMPANY
                  </h5>
                  <ul className="px-0">
                ...
                <div className=" sm:w-1/4 w-3/6 flex items-center flex-col pt-0 mt-4 sm:mt-0 sm:pt-5">
                  <h5 className="family-pops md:text-lg text-sm font-semibold not-italic text-white mb-4 ">
                    YOUR ACCOUNT
                  </h5>
                  <ul className="px-0">
        ...
        <div className="bg-[#171717] py-4 mt-10">
          <p className="text-center mb-0 family-pops md:text-lg text-[10px] text-[#b9b9b9] font-normal not-italic">

...
import redshoe from "../assets/images/rs.png";
import greyshoe from "../assets/images/gs.png";
function SectionThree() {
  return (
    <>
      <section className=" pb-20">
        <div className=" container mx-auto px-3">
          <h2 className="family-pops text-black md:text-3xl text-base font-semibold not-italic">
            RELATED PRODUCT
          </h2>
          <div className="flex flex-row flex-wrap mx-3 justify-center">
            <div className="xl:w-1/4 sm:w-2/4 w-full px-3 pt-9">
              <div className=" rounded-[17px] border-[1px] border-[#0000002e] overflow-hidden">
                <div className=" relative">
                  <img src={redshoe} alt="#" className="w-full" />
                  <div className=" absolute rotate-[-42deg] bg-[#d36b31] w-[130px] h-6 top-[10%] left-[-12%]">
                    <p className=" text-center text-white family-pops font-light md:text-sm text-[10px] not-italic md:mt-[2px] mt-[4px]">
                      -10% OFF
                    </p>
                  </div>
                  <div className="absolute w-[68px] h-[29px] model bg-[#555] top-0 right-0">
                    <p className="text-white family-pops md:text-sm text-xs not-italic font-normal text-center mt-[4px]">
                      NEW
                    </p>
                  </div>
                </div>
                <div className=" pt-[18px] px-[14px] pb-[30px]">
                  <div className="flex justify-between items-center">
                    <p className="text-[#555] family-pops not-italic font-medium md:text-lg text-base mb-0">
                  ...
                  <p className="text-[#999] family-pops not-italic md:text-lg text-base font-medium">
                    $90.00{" "}
                    <span className="text-[#f00] family-pops md:text-lg text-base not-italic font-medium">
                      $70.00
                    </span>
                  </p>
                  <svg
            ...
            <div className="xl:w-1/4 sm:w-2/4 w-full px-3 pt-9">
              <div className=" rounded-[17px] border-[1px] border-[#0000002e] overflow-hidden">
                <div className=" relative">
                  <img src={greyshoe} alt="#" className="w-full" />
                  <div className=" absolute rotate-[-42deg] bg-[#d36b31] w-[130px] h-6 top-[10%] left-[-12%]">
                    <p className=" text-center text-white family-pops font-light md:text-sm text-[10px] not-italic md:mt-[2px] mt-[4px]">
                      -10% OFF
                    </p>
          ...
          <div className=" pt-9">
            <div className="flex flex-row flex-wrap mx-3 justify-end gap-2 mt-9">
              <div className="flex justify-center items-center md:w-[59px] w-9 md:h-[59px] h-9 rounded-[9px] bg-[#f40] shadow-mycustomsd cursor-pointer">
                <p className="mb-0 text-white family-pops md:text-2xl text-base not-italic font-semibold  ">
                  1
                </p>
              </div>
              <div className="flex justify-center items-center md:w-[59px] w-9 md:h-[59px] h-9 rounded-[9px] bg-[#fff] transition-all hover:bg-[#ff4400] opacity-[0.8] shadow-mycustomsd cursor-pointer page-txt">
                <p className="mb-0 family-pops md:text-2xl text-base not-italic font-semibold  txt">
                  2
                </p>
              </div>
              <div className="flex justify-center items-center md:w-[59px] w-9 md:h-[59px] h-9 rounded-[9px] bg-[#fff] transition-all hover:bg-[#ff4400] opacity-[0.8] shadow-mycustomsd cursor-pointer page-txt">
              ...
              <button className="family-pops text-[#555] md:text-base text-xs not-italic font-normal flex justify-center items-center px-6 rounded-[9px] border-[1px] border-[#9c9c9c] transition-all bg-[#00000000] hover:bg-[#ff4400] hover:border-[1px] hover:border-[#ff4400] hover:text-white">
                Next {">>"}
              </button>
            </div>
          </div>

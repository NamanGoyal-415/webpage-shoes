...
import redshoes from "../assets/images/redshoe.png";
import blackshoe from "../assets/images/black-shoe.png";
import greyshoe from "../assets/images/grey-shoe.png";
import bgshoe from "../assets/images/black-grey-shoe.png";
...
export const HeroSection = () => {
  ...
  return (
    <>
      <header className=" sm:py-6 py-12">
        <div className="container mx-auto px-3 lg:py-0 py-6">
          <div className="flex lg:flex-row flex-wrap flex-col-reverse mx-3 py-4">
            <div className=" lg:w-5/12 w-full lg:pt-0 pt-12 px-3">
              <div className="shoes-box  py-[58px] px-0 bg-[#F3F3F3]">
                <img className=" w-fit" src={redshoe} alt="RedShoe" />
              </div>
              <div className="flex-row flex flex-wrap pt-6">
                <div className=" w-1/4 px-3">
                  <img className=" w-full" src={blackshoe} alt="blackShoe" />
                </div>
                <div className=" w-1/4 px-3">
                  <img className=" w-full" src={redshoes} alt="redShoe" />
                </div>
                <div className=" w-1/4 px-3">
                  <img className=" w-full" src={greyshoe} alt="greyShoe" />
                </div>
                <div className=" w-1/4 px-3">
                  <img className=" w-full" src={bgshoe} alt="black-greyShoe" />
                </div>
              </div>
            </div>
            <div className=" lg:w-7/12 px-3 w-full pt-6">
              <div className=" px-6">
                <h2 className="family-pops text-black lg:text-3xl text-lg font-semibold not-italic leading-normal">
                  PREMIUM MENS SPORTS LATHER KEDS
                </h2>
                <div className="md:flex block items-center gap-[10px] mt-2 mb-1">
                  <svg
                  ...
                  <p className="review family-pops text-black not-italic font-normal lg:text-xl text-sm mt-3 lg:mt-0">
                    ( 5 Customer Review )
                  </p>
                </div>
                <p className="mb-2 mt-4 text-[#666666] family-pops md:text-xl text-sm not-italic font-normal mr-1">
                ...
                <div className="flex items-center lg:my-4 my-12  lg:gap-4 gap-1">
                  <p className="mb-0 block text-black family-pops lg:text-xl text-sm not-italic font-medium">
                    Qty:
                  </p>
                  <div className=" relative">
                    <button className="ml-[21px] w-[108px] bg-transparent py-[10px] px-[5px] rounded-[21px] border-[1px] border-[#e8e8e8] bg-color text-[#555] familt-jose lg:text-xl text-sm not-italic font-normal">
                      {count}
                    </button>
                    <div className=" absolute flex justify-between items-center add-on-btns">
                      <button
                        onClick={SubItem}
                        className="head-links ml-[15px] text-[#555] family-jose border-0 outline-0 text-xl not-italic font-normal"
                      >
                        -
                      </button>
                      <button
                        onClick={AddItem}
                        className="head-links ml-[45px] text-[#555] family-jose border-0 outline-0 text-xl not-italic font-normal"
                      >
                        +
                      </button>
                    </div>
                  </div>
                  <button className=" rounded-[21px] bg-[#28a745] lg:py-[10px] py-[5px] px-[15px] lg:px-[32px] text-white family-pops lg:text-xl text-[8px] not-italic font-medium border-[1px] border-[transparent] duration-200 ease-linear hover:text-[#28a745] hover:border-[1px] hover:border-[#28a745] hover:bg-[white]">
                    Add to Cart
                  </button>
                </div>
                <div className=" flex items-center md:gap-[10px] gap-1">
                  <label
                    htmlFor="size"
                    className="text-black family-pops lg:text-xl text-sm not-italic font-medium"
                  >
                    Size:
                  </label>
                  <div className=" rounded-[21px] border-[1px] border-[#e8e8e8] bg-color ml-[21px] px-[13px] py-3 w-28">
                    <select
                      name="size"
                      id="size"
                      className=" w-full border-[1px] border-[transparent] rounded-[21px] bg-color outline-0 py-0 px-3 text-[#555] family-jose lg:text-xl text-sm not-italic font-normal ml-[-12px] mt-[-15px]"
                    >
                ...
                <div className=" flex items-center pt-5 md:gap-4 gap-1">
                  <label
                    htmlFor="size"
                    className="text-black family-pops lg:text-xl text-sm not-italic font-medium"
                  >
                  ...
                  <div className=" flex items-center gap-2">
                    <input
                      className="w-9 h-9 border-[1px] bg-white"
                      type="color"
                      id="favcolor"
                      name="favcolor"
                      value="#CC111C"
                ...
                <div className="flex pt-8 gap-7">
                  <div className="flex items-center">
                    ...
                    <p className="mb-0 family-pops lg:text-base text-xs font-light not-italic text-[#222]">
                      Compare
                    </p>
                  </div>
                  <div className="flex items-center">
                ...
                <div className="w-full h-[1px] bg-black opacity-50 mt-9"></div>
